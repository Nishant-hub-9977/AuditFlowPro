...
async function seed() {
  ...
  const industries = [
    ...
    },
    {
      tenantId,
      name: "Food & Beverage",
      description: "Restaurants, cafes, and food processing",
    },
    {
      tenantId,
      name: "Construction",
      description: "Construction sites and infrastructure",
    },
    {
      tenantId,
      name: "Logistics",
      description: "Warehousing and distribution centers",
    },
    {
      tenantId,
      name: "Education",
    ...
    },
    {
      tenantId,
      name: "Hospitality",
      description: "Hotels, resorts, and accommodation",
    },
    {
      tenantId,
      name: "Technology",
      description: "IT companies and data centers",
    },
    {
      tenantId,
      name: "Agriculture",
  ...
  const auditTypes = [
    {
      tenantId,
      name: "Safety Audit",
      description: "Comprehensive workplace safety inspection",
    },
    {
      tenantId,
      name: "Quality Audit",
      description: "Product and process quality assessment",
    },
    {
      tenantId,
      name: "Environmental Audit",
      description: "Environmental compliance and sustainability audit",
    },
    {
      tenantId,
      name: "Compliance Audit",
      description: "Regulatory and legal compliance audit",
    },
    {
      tenantId,
      name: "Financial Audit",
      description: "Financial controls and accounting audit",
    },
    {
      tenantId,
    ...
    },
    {
      tenantId,
      name: "Security Audit",
      description: "Physical and information security audit",
    },
    {
      tenantId,
      name: "Fire Safety Audit",
      description: "Fire safety systems and procedures audit",
    },
  ];
  ...
  const [safetyAuditType] = await db
    .select()
    .from(schema.auditTypes)
    .where(eq(schema.auditTypes.name, "Safety Audit"))
    .limit(1);
      ...
      const checklistItems = [
        {
          ...
          question: "Are fire extinguishers properly located and accessible?",
        ...
        {
          checklistId: checklist.id,
          question: "Are employees wearing appropriate PPE?",
          category: "Personal Safety",
          orderIndex: 3,
        },
        {
          checklistId: checklist.id,
          question: "Are work areas clean and free from hazards?",
        ...
        {
          checklistId: checklist.id,
          question: "Are electrical panels properly covered and labeled?",
          category: "Electrical Safety",
          orderIndex: 6,
        },
        {
          checklistId: checklist.id,
          question: "Are chemical storage areas properly ventilated?",
          category: "Chemical Safety",
          orderIndex: 7,
        },
        {
          checklistId: checklist.id,
          question: "Are machinery guards in place and functioning?",
        ...
        {
          checklistId: checklist.id,
          question: "Are safety procedures documented and accessible?",
  ...
  const [qualityAuditType] = await db
    .select()
    .from(schema.auditTypes)
    .where(eq(schema.auditTypes.name, "Quality Audit"))
    .limit(1);

  if (qualityAuditType) {
    console.log("Creating quality audit checklist...");

    const [qualityChecklist] = await db
      .insert(schema.checklists)
      .values({
        tenantId,
    ...
    if (qualityChecklist) {
      const qualityItems = [
        {
          checklistId: qualityChecklist.id,
          question: "Are quality objectives documented and measurable?",
          category: "Quality Planning",
          orderIndex: 1,
        },
        {
          checklistId: qualityChecklist.id,
          question: "Is there a documented quality management system?",
          category: "Documentation",
          orderIndex: 2,
        },
        {
          checklistId: qualityChecklist.id,
          question: "Are quality records maintained and accessible?",
          category: "Record Keeping",
          orderIndex: 3,
        },
        {
          checklistId: qualityChecklist.id,
          question: "Are inspection procedures followed consistently?",
          category: "Quality Control",
          orderIndex: 4,
        },
        {
          checklistId: qualityChecklist.id,
          question: "Is there a process for handling non-conforming products?",
          category: "Non-Conformance",
          orderIndex: 5,
        },
        {
          checklistId: qualityChecklist.id,
          question: "Are customer complaints tracked and resolved?",
          category: "Customer Satisfaction",
          orderIndex: 6,
        },
        {
          checklistId: qualityChecklist.id,
          question: "Is corrective action process effective?",
          category: "Continuous Improvement",
          orderIndex: 7,
        },
        {
          checklistId: qualityChecklist.id,
          question: "Are suppliers evaluated and monitored?",
